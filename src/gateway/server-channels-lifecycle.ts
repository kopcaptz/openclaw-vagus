...
type ChannelLifecycleService = Pick<
  ChannelManager,
  "startChannels" | "startChannel" | "stopChannel" | "markChannelLoggedOut"
>;

type ChannelLifecycleServiceParams = {
...
export function createChannelLifecycleService(
  params: ChannelLifecycleServiceParams,
